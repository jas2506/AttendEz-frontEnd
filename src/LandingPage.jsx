...
import { Mail, ShieldCheck, GraduationCap, Users, ArrowRight, CheckCircle, Sparkles } from "lucide-react"
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 text-slate-800 relative overflow-hidden">
        ...
        >
          <div className="group">
            ...
            <p className="text-sm mt-1 text-slate-600 font-medium">Fast, Transparent and Secure.</p>
          </div>
        ...
        <main className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-between px-8 py-16 gap-16 max-w-7xl mx-auto w-full">
          ...
          <div
              ...
              className={`flex-1 max-w-2xl space-y-10 transition-all duration-1000 delay-300 ${
                  isVisible["hero-content"] ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-20"
              }`}
          >
            <div className="space-y-6">
              <h2 className="text-4xl lg:text-6xl font-bold leading-tight text-slate-900 tracking-tight">
                ...
                <span className="inline-block hover:scale-105 transition-transform duration-300 delay-100">to</span>
              ...
              >
                An attendance management system designed by students, for students. Streamline your educational workflows
            ...
            <div
                ...
                className={`space-y-4 transition-all duration-1000 delay-500 ${
                    isVisible.features ? "opacity-100 translate-y-0" : "opacity-30 translate-y-10"
                }`}
            >
              {[
          ...
          <div
              ...
              className={`flex-shrink-0 transition-all duration-1000 delay-700 ${
                  isVisible["role-selector"] ? "opacity-100 translate-x-0 scale-100" : "opacity-0 translate-x-20 scale-95"
              }`}
          >
        ...
        >
          <p className="text-sm">©️ {new Date().getFullYear()} AttendEz. All rights reserved.</p>
          <a
              href="/contact"
          ...
          >
            Contact Us
            <Mail size={14} className="group-hover:translate-x-1 group-hover:scale-110 transition-all duration-300" />
          </a>
        </footer>
