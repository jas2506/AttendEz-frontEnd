import {
  ...
  function FacultyHomepageComponent() {
    const classdetails = {
      className: "COA",
      section: "CSE-B",
      year: "UG-2027",
    ...
    endTime.setMinutes(endTime.getMinutes() + classdetails.durationMinutes);
    const formattedEndTime = endTime.toTimeString().slice(0, 5);
  
    return (
      <div className="bg-gradient-to-b from-gray-100 to-white px-4 md:px-6 py-3">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-3">
              ...
              <div className="text-right">
                ...
                <p className="text-base font-semibold text-gray-800">
                  {classdetails.durationMinutes} mins
                </p>
              </div>
            </div>
